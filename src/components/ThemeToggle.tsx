...
const ThemeToggle = () => {
  ...
  return (
    <button
      ...
      className="fixed z-50 bottom-5 right-5 p-2.5 rounded-full bg-gradient-to-r from-primary/20 to-primary/40 backdrop-blur-md shadow-lg dark:shadow-primary/20 hover:shadow-xl transition-all duration-300 hover:scale-110 border border-primary/20 dark:border-primary/30 group overflow-hidden"
