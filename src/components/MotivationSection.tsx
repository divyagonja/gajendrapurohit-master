...
const MotivationSection = () => {
  return (
    <section id="motivation-section" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {motivationalTalks.map((talk) => (
            <Card key={talk.id} className="h-full shadow-sm hover:shadow-md transition-shadow">
              ...
              <CardContent className="pb-4">
                <p className="text-gray-600 text-xs">{talk.description}</p>
              </CardContent>
              <CardFooter>
                <Button 
                  className="w-full" 
